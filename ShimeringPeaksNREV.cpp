//g++ -Istk/include/ -Lstk/src/ -D__MACOSX_CORE__ ShimmeringPeaksNREV.cpp -lstk -lpthread -framework CoreAudio -framework CoreMIDI -framework CoreFoundation -o ShimmeringPeaks-NRev
